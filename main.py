...
if __name__ == "__main__":
    ...
    PORT = int(os.environ.get('PORT', 8443))  # Render або інший хостинг надає порт
    WEBHOOK_URL = os.environ.get("WEBHOOK_URL")  # твій домен, напр. https://gpt-bot.onrender.com/webhook
